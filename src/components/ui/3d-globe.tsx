      ...
      <group ref={imageGroupRef} position={topPosition}>
        ...
        >
          ...
          >
            <div
              className={cn(
                "overflow-hidden rounded-full bg-neutral-900 shadow-lg transition-all duration-300 border border-white/20",
                hovered && "scale-150 shadow-xl ring-2 ring-red-500/50 border-white/40",
              )}
              style={{
                width: "32px",
                height: "32px",
            ...
            {hovered && marker.label && (
              <div className="whitespace-nowrap rounded-full bg-black/80 px-2 py-0.5 text-[9px] font-medium text-white backdrop-blur-sm">
                {marker.label}
              </div>
            )}
          </div>
